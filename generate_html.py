...
for topic in conf["topics"]:
    ...
    if not isStdTopic(topic):
        ...
        if topic.get("std_wifi") == True:
            ...
            html += '</div>\n'            
            html += '<div class="tr">\n'
            html += '\t\t\t<div class="td right">Prefix</div>\n'
            html += '\t\t\t<div class="td"><input type="text" name="std_mqtt_prefix"></div>\n'
            html += '</div>\n'            
            html += '<div class="tr">\n'
            html += '\t\t\t<div class="td right">Object ID</div>\n'
            html += '\t\t\t<div class="td"><input type="text" name="std_mqtt_objid"></div>\n'
            html += '</div>\n'
            html += '<div class="tr">\n'
            html += '\t\t\t<div class="td right">Discovery</div>\n'
            html += '\t\t\t<div class="td"><input type="checkbox" name="std_mqtt_disc"></div>\n'
            html += '</div>\n'            
            html += '</fieldset>\n'
